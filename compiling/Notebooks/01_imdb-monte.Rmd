...
Grab the first 5000 `nmid` values, and run through the same ringer (will be lots of overlap).

### Seed movieCount5000 (September 2020)

From 68,784 movies above, find the actors that have the most movies.  Grab the top 5000 `nmid` of the most prolific worker.

### Seed boxOfficeMoney5000 (September 2020)

From 68,784 movies above, find the actors that have the most money.  Grab the top 5000 `nmid` of the most prolific blockbuster participants.

### Seed movieAvgRating5000 (September 2020)

From 68,784 movies above, find the actors that highest movie rating (average, minimum of 25 movies).  Grab the top 5000 `nmid` of the most prolific winner participants.
